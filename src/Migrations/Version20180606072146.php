 ...
 */
final class Version20180606072146 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD folder VARCHAR(255) NOT NULL, ADD date_inscription DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP folder, DROP date_inscription');
    }
}
